const AppVersion = require("../models/AppWithoutBarrierVersion");
const utils = require("./utils");
const { Validator } = require("node-input-validator");
exports.getLatestAppWithoutBarrierVersion = async (req, res) => {
  try {
...
exports.updateAppWithoutBarrierVersion = async (req, res) => {
  try {
